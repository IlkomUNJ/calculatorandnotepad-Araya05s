...
import com.example.basicscodelab.CalculatorUIComponents.DarkLightOrange

object CalculatorScreen_Screen {
    @Composable
    fun setupLayout(navController: NavHostController, viewModel: CalculatorViewModel = viewModel()) {
        val screenValue by viewModel.screenValue.collectAsState()
        val screenResultValue by viewModel.screenResultValue.collectAsState()
        ...
        Column(
            ...
            CalculatorUIComponents.calculatorShowMath(modifier = Modifier.padding(2.dp, 2.dp), screenValue)
            Box(
                modifier = Modifier
                    .fillMaxWidth()
                    .height(2.dp)
            ...
            CalculatorUIComponents.calculatorShowResult(modifier = Modifier.padding(20.dp, 20.dp), screenResultValue)
            Row(
                horizontalArrangement = Arrangement.spacedBy(8.dp)
            ) {
                CalculatorUIComponents.calculatorScientificButton(Modifier.padding(2.dp), "Sin", screenValue) { updatedValue -> viewModel.updateScreenValue(updatedValue) }
                CalculatorUIComponents.calculatorScientificButton(Modifier.padding(2.dp), "Cos", screenValue) { updatedValue -> viewModel.updateScreenValue(updatedValue) }
                CalculatorUIComponents.calculatorScientificButton(Modifier.padding(2.dp), "Tan", screenValue) { updatedValue -> viewModel.updateScreenValue(updatedValue) }
                CalculatorUIComponents.calculatorScientificButton(Modifier.padding(2.dp), "(", screenValue) { updatedValue -> viewModel.updateScreenValue(updatedValue) }
            }
            Row(
                horizontalArrangement = Arrangement.spacedBy(8.dp)
            ) {
                CalculatorUIComponents.calculatorScientificButton(Modifier.padding(2.dp), "log", screenValue) { updatedValue -> viewModel.updateScreenValue(updatedValue) }
                CalculatorUIComponents.calculatorScientificButton(Modifier.padding(2.dp), "ln", screenValue) { updatedValue -> viewModel.updateScreenValue(updatedValue) }
                CalculatorUIComponents.calculatorScientificButton(Modifier.padding(2.dp), "x!", screenValue) { updatedValue -> viewModel.updateScreenValue(updatedValue) }
                CalculatorUIComponents.calculatorScientificButton(Modifier.padding(2.dp), ")", screenValue) { updatedValue -> viewModel.updateScreenValue(updatedValue) }
...
// --- Scientific Row 3 (Reciprocal & Root/Power) ---
            Row(
                ...
                CalculatorUIComponents.calculatorScientificButton(Modifier.padding(2.dp), "1/x", screenValue) { updatedValue -> viewModel.updateScreenValue(updatedValue) }
                CalculatorUIComponents.calculatorScientificButton(Modifier.padding(2.dp), "sqrt(x)", screenValue) { updatedValue -> viewModel.updateScreenValue(updatedValue) } // Added sqrt(x)
                CalculatorUIComponents.calculatorScientificButton(Modifier.padding(2.dp), "x^y", screenValue) { updatedValue -> viewModel.updateScreenValue(updatedValue) } // Changed "xy" to "x^y" for clarity
                CalculatorUIComponents.calculatorScientificButton(Modifier.padding(2.dp), "π", screenValue) { updatedValue -> viewModel.updateScreenValue(updatedValue) } // Core operator moved up
            }
...
// --- Control Row 4 (AC, Del, Inv) ---
            Row(
                ...
                CalculatorUIComponents.calculatorACButton(Modifier.padding(2.dp)) { viewModel.clear() }
                CalculatorUIComponents.calculatorOperationButton(Modifier.padding(2.dp), "Del", screenValue) { updatedValue -> viewModel.updateScreenValue(updatedValue) }
                CalculatorUIComponents.calculatorScientificButton(Modifier.padding(2.dp), "Inv", screenValue) { updatedValue -> viewModel.updateScreenValue(updatedValue) }
                CalculatorUIComponents.calculatorOperationButton(Modifier.padding(2.dp), "/", screenValue) { updatedValue -> viewModel.updateScreenValue(updatedValue) }
            }
            Row(
                horizontalArrangement = Arrangement.spacedBy(8.dp)
            ) {
                CalculatorUIComponents.calculatorButton(Modifier.padding(2.dp), 7, screenValue) { updatedValue -> viewModel.updateScreenValue(updatedValue) }
                CalculatorUIComponents.calculatorButton(Modifier.padding(2.dp), 8, screenValue) { updatedValue -> viewModel.updateScreenValue(updatedValue) }
                CalculatorUIComponents.calculatorButton(Modifier.padding(2.dp), 9, screenValue) { updatedValue -> viewModel.updateScreenValue(updatedValue) }
                CalculatorUIComponents.calculatorOperationButton(Modifier.padding(2.dp), "*", screenValue) { updatedValue -> viewModel.updateScreenValue(updatedValue) }
            }
            Row(
                horizontalArrangement = Arrangement.spacedBy(8.dp)
            ) {
                CalculatorUIComponents.calculatorButton(Modifier.padding(2.dp), 4, screenValue) { updatedValue -> viewModel.updateScreenValue(updatedValue) }
                CalculatorUIComponents.calculatorButton(Modifier.padding(2.dp), 5, screenValue) { updatedValue -> viewModel.updateScreenValue(updatedValue) }
                CalculatorUIComponents.calculatorButton(Modifier.padding(2.dp), 6, screenValue) { updatedValue -> viewModel.updateScreenValue(updatedValue) }
                CalculatorUIComponents.calculatorOperationButton(Modifier.padding(2.dp), "+", screenValue) { updatedValue -> viewModel.updateScreenValue(updatedValue) }
            ...
            Row(
                ...
                CalculatorUIComponents.calculatorButton(Modifier.padding(2.dp), 7, screenValue) { updatedValue -> viewModel.updateScreenValue(updatedValue) }
                CalculatorUIComponents.calculatorButton(Modifier.padding(2.dp), 2, screenValue) { updatedValue -> viewModel.updateScreenValue(updatedValue) }
                CalculatorUIComponents.calculatorButton(Modifier.padding(2.dp), 3, screenValue) { updatedValue -> viewModel.updateScreenValue(updatedValue) }
                CalculatorUIComponents.calculatorOperationButton(Modifier.padding(2.dp), "-", screenValue) { updatedValue -> viewModel.updateScreenValue(updatedValue) }
            ...
            Row(
                ...
                CalculatorUIComponents.calculatorDoubleButton(Modifier.padding(2.dp), "000", screenValue) { updatedValue -> viewModel.updateScreenValue(updatedValue) }
                CalculatorUIComponents.calculatorButton(Modifier.padding(2.dp), 0, screenValue) { updatedValue -> viewModel.updateScreenValue(updatedValue) }
                CalculatorUIComponents.showCalculatorResult(Modifier.padding(2.dp), screenValue = screenValue) { updatedValue -> viewModel.calculateResult() }
            }
        }
    }
}
